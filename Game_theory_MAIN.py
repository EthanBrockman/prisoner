...
# calls the player and prisoner class to begin the game

amount_of_games = int(input("Enter the number of games: "))
P1_strategy = int(input("Enter the number of the strategy for player 1: "))
P2_strategy = int(input("Enter the number of the strategy for player 2: "))
...
writing_file.write(f'\nPrisoner 1 Sentence is {sentence1()} years\nPrisoner 2 sentence is {sentence2()} years')
writing_file.close()
